...
The main challenge during this sprint was the hardware issues with the ESP32 Marauder. The SD card was not being detected, which was a major blocker for the project. This issue was resolved by identifying a faulty SD card and replacing it with a new one. The troubleshooting process was documented in detail to help prevent similar issues in the future.
...
## Sprint 3 Review
This sprint was successful in resolving the hardware issues with the ESP32 Marauder, which was a major accomplishment. The detailed documentation of the troubleshooting process will be a valuable resource for the project moving forward. The main area for improvement is to more quickly identify and resolve hardware issues to minimize their impact on the project timeline.
